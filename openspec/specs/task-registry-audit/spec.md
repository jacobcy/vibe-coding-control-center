...
## Purpose
Perform comprehensive audit of task registration completeness across multiple sources (worktrees, branches, PRs, OpenSpec changes) to ensure data integrity and identify missing registrations.
