...
- Update documentation in `docs/standards/command-standard.md` to clarify that vibe flow does not use `worktrees.json` to express the open site/container as a logical anchor.
...
- **Documentation**: `docs/standards/command-standard.md`.
