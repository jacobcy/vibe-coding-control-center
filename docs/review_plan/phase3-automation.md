...
related_docs:
  ...
  - docs/review_plan/phase2-integration.md
...
```
scripts/python/vibe3/services/commit_analyzer.py  # Commit 分析服务
scripts/python/vibe3/commands/hooks.py            # Hook 管理命令
...
```
scripts/python/vibe3/config/settings.py            # 添加 review 配置
scripts/python/vibe3/commands/review.py            # 添加 post-comments
scripts/python/vibe3/clients/github_client.py      # 添加 status API
```
