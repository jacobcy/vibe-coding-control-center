...
**详细说明**: [v3 命令参数标准](../../v3/implementation/07-command-standards.md)
...
所有命令必须遵守 **[v3 命令参数标准](../../v3/implementation/07-command-standards.md)**，包含以下核心参数：
...
详见 **[07-command-standards.md](../../v3/implementation/07-command-standards.md)**。
...
scripts/python/vibe3/services/command_analyzer.py # 命令调用链路分析
```
