...
Vibe Coding Framework 的核心架构设计，包含设计方案和实现计划。
...
### Plan（执行计划层）
- [plan-v1-design.md](plan-v1-design.md) - Vibe 架构设计
- [plan-v2-implementation.md](plan-v2-implementation.md) - Vibe 架构实现计划
