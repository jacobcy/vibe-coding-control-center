...
```bash
rg -n "terminal|merged PR|follow-up issue|新的 repo issue|roadmap item" tests/skills/test_skills.bats docs/standards/v3/git-workflow-standard.md docs/standards/v3/handoff-governance-standard.md
```
...
```bash
rg -n "plan.*terminal|merged PR.*terminal|follow-up.*repo issue|roadmap item" docs/standards/v3/git-workflow-standard.md docs/standards/v3/handoff-governance-standard.md
```
...
```bash
git add docs/standards/v3/git-workflow-standard.md docs/standards/v3/handoff-governance-standard.md
...
1. 打开 `docs/standards/v3/git-workflow-standard.md`，确认 merged PR 后旧 plan 只允许补证据与 follow-up 链接
