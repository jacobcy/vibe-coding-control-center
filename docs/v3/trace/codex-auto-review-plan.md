...
related_docs:
  ...
  - docs/v3/trace/codex-review-phases.md
---
...
>
> **实施标准**: 所有实现必须遵守 **[v3 技术标准](../v3/infrastructure/03-coding-standards.md)**。
...
核心要求:
- 编码标准: [docs/v3/infrastructure/03-coding-standards.md](../v3/infrastructure/03-coding-standards.md)
...
更多执行细节请参考 **[Codex Review 实施阶段计划](codex-review-phases.md)** 和各 Phase 详细文档。
...
- [serena-usage.md](../standards/serena-usage.md) - Serena 使用标准
