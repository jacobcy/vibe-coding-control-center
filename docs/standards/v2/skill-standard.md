...
本文档**不**定义每个具体 Vibe skill 的应用时机、冲突优先级和自然语言触发矩阵；这些内容以 `docs/standards/v2/skill-trigger-standard.md` 为准。
...
正式触发与分流以 `docs/standards/v2/skill-trigger-standard.md` 为准；个人查看用备忘见 `docs/references/skill-loop-memo.md`。
...
- 具体 skill 的“什么时候该介入、和邻近 skill 怎么分流”不在本文件展开，统一引用 `docs/standards/v2/skill-trigger-standard.md`。
