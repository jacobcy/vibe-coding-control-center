...
| 执行入口 | `vibe-start` | 切换分支后恢复执行环境、补齐 flow 注册、确认/补绑定 issue、补 PR draft | 修改业务代码、创建新 issue、创建新 branch |
...
| Vibe 执行技能 | 单 issue 到 PR 的执行代理 | `skills/vibe-manager/SKILL.md` | 由 vibe-new/vibe-start 触发 | 属于 Skill 层，负责执行闭环 |
