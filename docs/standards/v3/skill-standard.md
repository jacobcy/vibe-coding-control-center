...
| 编排层 | `vibe-orchestra` | 多 issue / 多 flow 的心跳治理、分诊、优先级调度、label 治理 | 单 flow 执行、写代码、manager 代理 |
| 执行层 | `vibe-manager` | 单 flow 执行闭环代理、派发 agent、观察 handoff、跟进到 PR ready | 多 flow 编排、写代码、label 治理 |
