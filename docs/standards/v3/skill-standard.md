...
| 执行层 | `vibe-manager` | 单 flow 现场创建与执行代理、派发 agent、观察 handoff、调用必要能力 | 多 flow 编排、写代码、替业务决定固定 workflow |
...
| Vibe 执行技能 | 单 issue 到 PR 的执行代理 | `skills/vibe-manager/SKILL.md` | 由 vibe-new 触发 | 属于 Skill 层，负责执行闭环 |
