...
_vibe_roadmap_usage() {
    ...
    echo "  ${GREEN}add${NC}           Add a local roadmap item mirror"
    echo "  ${GREEN}sync${NC}          Sync repo issues into local roadmap item mirrors (--provider github --repo owner/repo)"
    ...
    echo "  # current limitation: sync still mirrors repo issues directly; full GitHub Project item sync is pending"
