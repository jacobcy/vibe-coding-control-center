...
PROFILE_MINIMAL=(
    ...
    "paths.policies_root:\${HOME}/.vibe/supervisor/policies"
    "paths.prompts_root:\${HOME}/.vibe/config/prompts"
...
list_profiles() {
    ...
    echo "    - Uses global policies/prompts from ~/.vibe"
    echo ""
    ...
    echo "    - Symlinks global ~/.vibe/skills to supported agent skills dirs"
    echo "    - Uses global policies/prompts from ~/.vibe"
    echo ""
