...
| 旧命令 (vibe2) | 新命令 (vibe3) |
|---------------|---------------|
| `vibe flow show` | `uv run python src/vibe3/cli.py flow show` |
| `vibe flow new <slug>` | `uv run python src/vibe3/cli.py flow create <name> --base <branch>` |
| `vibe roadmap status` | `uv run python src/vibe3/cli.py task list` |
| `vibe roadmap list` | `uv run python src/vibe3/cli.py task list` |
| `vibe roadmap sync` | `uv run python src/vibe3/cli.py flow bind <issue>` |
