...
2. 若长时间没有 Codex / Copilot 在线 review，提醒用户在 PR 中 `@codex`
3. 若仍无线上 review，则运行 `vibe flow review --local` 或使用 browser/subagent 产出外部 review evidence
4. 将外部 review 结果回贴到 PR comment 后，再继续判断 merge readiness
