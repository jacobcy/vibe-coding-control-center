...
| 旧命令 (vibe2) | 新命令 (vibe3) |
|---------------|---------------|
| `vibe check` | `uv run python src/vibe3/cli.py check` |
| `vibe check link` | `uv run python src/vibe3/cli.py check --all` |
| `vibe task update --unassign` | `uv run python src/vibe3/cli.py check --fix` |
| `vibe task update --bind-current` | `uv run python src/vibe3/cli.py check --fix` |
