...
def test_exceptions_barrel_import_count() -> None:
    ...
    Current baseline: 159 call sites across 137 files (issue #2902).
    ...
    This is a growth-prevention baseline. It does NOT prescribe migrating
...
def test_config_barrel_import_count() -> None:
    ...
    Current baseline: 146 call sites across 103 files (issue #2902).
    ...
    full type information. This baseline tracks import volume as a growth
    prevention mechanism, not as a list of violations to migrate away from.
    """
