"""Tests for reset_task_scene operations."""
...
def test_reset_task_scene_deletes_branch_handoff_and_flow_truth(
...
def test_reset_task_scene_creates_tombstone_after_full_rebuild(
    make_operations: TaskResumeOperations,
) -> None:
...
def test_reset_task_scene_with_remote_keeps_remote_branch(
    make_operations: TaskResumeOperations,
) -> None:
