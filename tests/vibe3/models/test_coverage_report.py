...
class TestLayerCoverageComputedProperties:
    """Tests for LayerCoverage computed properties.

    Merged from test_layer_coverage.py.
    """

    def test_layer_coverage_creation(self) -> None:
    ...
    def test_layer_coverage_is_passing(self) -> None:
    ...
    def test_layer_coverage_gap(self) -> None:
        """Test gap property."""
    ...
    def test_layer_coverage_zero_coverage(self) -> None:
    ...
    def test_layer_coverage_perfect_coverage(self) -> None:
